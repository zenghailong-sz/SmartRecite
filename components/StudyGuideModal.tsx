      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            animate={{ scale: 1, y: 0 }} 
            exit={{ scale: 0.9, y: 20 }} 
            className="bg-white rounded-[4rem] w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl border border-white" 
          ...
          >
            <div className="p-10 border-b flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-3xl font-black text-gray-900 tracking-tight">智能学习指南</h3>
                  <p className="text-xs text-indigo-500 font-bold tracking-widest uppercase mt-1">SMART STUDY GUIDE</p>
                </div>
              </div>
              <button 
                onClick={onClose} 
                className="p-4 bg-white rounded-2xl text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all shadow-sm"
              >
                <X size={24}/>
              </button>
            </div>
            <div className="flex-1 overflow-y-auto p-10 space-y-12">
              <section>
                <h4 className="text-xl font-black text-indigo-600 mb-6 flex items-center gap-3"><Zap size={20}/> 艾宾浩斯加速版 (日内双循环)</h4>
              ...
              <section>
                <h4 className="text-xl font-black text-indigo-600 mb-6 flex items-center gap-3"><Command size={20}/> 键盘快捷键</h4>
              ...
              <section>
                <h4 className="text-xl font-black text-indigo-600 mb-6 flex items-center gap-3"><Link2 size={20}/> 单词家族功能</h4>
